...
import 'package:construction_mobile/presentation/theme/styles.dart';
...
class BaseDialog extends AlertDialog {
  ...
  Widget _generateContentWidget(BuildContext context) {
    ...
    final textStyle =
        dialogStyle != null && dialogStyle!.contentTextStyle != null
            ? dialogStyle!.contentTextStyle
            : cContentTextStyle;
        ...
        children: [
          Expanded(
            child: showTextActions
                ? _mapTextToGesWidget(
                    context, actionsText![0], 0, !rightMainButton,
                    type: ButtonType.Left)
                : actionsWidget![0],
          ),
          Container(
          ...
          Expanded(
            child: showTextActions
                ? _mapTextToGesWidget(
                    context, actionsText![1], 1, rightMainButton,
                    type: ButtonType.Right)
                : actionsWidget![1],
          )
        ],
